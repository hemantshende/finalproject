                            ...
                            <tr>
                                <td>
                                    <div className='imageBlock col-md-4 col-sm-6'> 
                                        <img src={imageUrl} alt=""  style={{ marginLeft: "10px", borderRadius: "20px", width: "170px", height: "170px" }}/>
                                    </div>
                                </td>
                                <td style={{ width: "600px" }}>
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            <h4 className='cartInfo float-end' style={{ marginRight: "20px" }}>Rs. {cartComps.price}</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col">
                                        ...
                                        <motion.button className='removebtn' onClick={() => { remove(cartComps); removefromDB(cartComps) }}
                                            whileHover={{ scale: 1.03, backgroundColor: "rgb(255, 0, 0)" }}
