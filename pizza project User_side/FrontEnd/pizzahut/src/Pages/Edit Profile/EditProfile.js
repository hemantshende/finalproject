                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><input onChange={e=>{
                                        ...
                                        type="text" className='personalInfo' required="true" /></td>
                                </tr><br />
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input onChange={e=>{
                                        ...
                                        type="email" className='personalInfo' required="true" /></td>
                                </tr><br />
                                <tr>
                                ...
                                <tr>
                                    <td colSpan={2}>
                                        <button className='float-end editUser' onClick={updateUser}>
                                            Update
                                        </button>
                                    </td>
                                </tr><br />
