...
public class PaymentDto {
	...
	public PaymentDto(int userId, int addresspayId, String payStatus, Date payTimeStamp, String mode) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "PaymentDto [userId=" + userId + ", addresspayId=" + addresspayId + ", payStatus=" + payStatus
				+ ", payTimeStamp=" + payTimeStamp + ", mode=" + mode + ", getClass()=" + getClass() + ", hashCode()="
