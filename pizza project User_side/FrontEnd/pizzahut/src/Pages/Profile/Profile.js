                    ...
                    <div>
                        ...
                        <table  className='table-responsive' id='prtable'>
                            <tr>
                                ...
                                <td><input type="text" value={currentfirstName} className="personalInfo" readOnly="true" /></td>
                            </tr><br />
                            <tr>
                                <td style={{ textAlign: "right" }}><b>Last Name</b></td>
                                <td><input type="text" value={currentlastName} className="personalInfo" readOnly="true" /></td>
                            </tr><br />
                            <tr>
                                <td style={{ textAlign: "right" }}><b>Email</b></td>
                                <td><input type="text" value={currentemail} className="personalInfo" readOnly="true" /></td>
                            </tr><br />
                            <tr>
                                <td style={{ textAlign: "right" }}><b>Phone Number</b></td>
                                <td><input type="text" value={currentphoneNo} className="personalInfo" readOnly="true" /></td>
                            </tr><br />
                            <tr>
                                <td colSpan={2}>
