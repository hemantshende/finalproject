...
export default function Cart() {
    ...
    const getCartItem = () => {
        const url = `${URL}cart/${currentuserId}/1`
            ...
            <div style={{ backgroundColor: "whitesmoke" }}>
                ...
                <div className=' container shadow-lg' style={{ backgroundColor: "white", minHeight: "500px" }}>
                    ...
                    <div style={{ textAlign: "right", marginRight: "10%" }}>
                        <h5 className='amountInfo'>Total amount to be Paid : {<TotalAmount />} Rs</h5>
                        <motion.button className='btn btn-primary btn-lg payBtn ' id='payid'
                            whileHover={{ scale: 1.03, backgroundColor: "yellow", color: "black" }}
                            whileTap={{ scale: 1, backgroundColor: "yellow", color: "black" }}
