                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <div className='addresscontainer'>
                                            ...
                                            <h6>Street Name : {thisdetail.deliveryId.address.streetName}</h6>
                                            <h6>City :        {thisdetail.deliveryId.address.city}</h6>
                                            <h6>District :    {thisdetail.deliveryId.address.district}</h6>
                                            <h6>State :       {thisdetail.deliveryId.address.soverignState}</h6>
                                    ...
                                    <div className="col">
                                        ...
                                        <div className='addresscontainer'>
                                            <h6>Payment Id :        {thisdetail.deliveryId.payments.payId}</h6>
                                            <h6>Payment status :     {thisdetail.deliveryId.payments.payStatus}</h6>
                                            <h6>Payment mode : {thisdetail.deliveryId.payments.mode}</h6>
                                        </div> <hr />
                                        <div className='addresscontainer'>
                                            <h6>Delivery status :{thisdetail.deliveryId.deliveryStatus}</h6>
                                        </div>
                                    </div>
                                </div>
                                <br />
                                        ...
                                        <div className="row">
                                            <div className="col">
                                                <div className='imageBlock'>
                                                    <center>
                                                        <img src={URL + 'itemImage/item/' + thisdetail.itemsize.item.itemid} alt="" style={{borderRadius: "20px", width: "280px", height: "200px" }} />
                                                    </center>
                                                </div>
                                            </div>
                                            <div className="col">
                                                ...
                                                <h6 className='cartInfo' >Delivery Status : {thisdetail.deliveryId.deliveryStatus}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <br />
                                <button className='btn btn-primary float-end' onClick={()=>(navigate('/MyOrders'))}>Back</button>
                                <br />
                                <br />
                            </div>
